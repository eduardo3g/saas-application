...
class UserController {
  async store ({ request, response, auth }) {
    ...
    // Check if there's any invitation to this user
    const teamsQuery = Invite.query().where('email', data.email)

    // pluck function returns an array with team_id
    ...
    // Delete all invites for the user because he was already created
